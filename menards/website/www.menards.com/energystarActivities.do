...
<title>Menards.com - ENERGY STAR Activities Page</title>
...
<h1><span></span>ENERGY STAR<span class="registered">&reg;</span> Activities</h1>
<br />
<div id="page" class="secondaryPage">
  
  <img border="0" src="web/static/images/energyStar/esActForKids.jpg" id="esActKidsImg" />
  <div class="mainContent">

    <div class="leftFloat" style="width: 520px; padding-right: 5px;">
    <h3>ENERGY STAR Fast Facts:</h3>
      <p>Find out how much you can save each year by using the Fast Facts worksheets to complete the Guide to the Stars Treasure Hunt. <a href="web/static/pdf/FastFacts.pdf" target="_blank" style="text-decoration:underline;">Click Here for the ENERGY STAR Fast Facts.</a></p>
      <br /><br />
    <h3>Guide to the Stars Treasure Hunt:</h3>
      <p>Use the ENERGY STAR Fast Facts to fill in the savings treasure on the Treasure Hunt. <br /><a href="web/static/pdf/TreasureMap.pdf" target="_blank" style="text-decoration:underline;">Click Here for the Guide to the Stars Treasure Hunt.</a></p>
      <br /><br />
    <h3>ENERGY STAR<span class="registered">&reg;</span> Activity Book:</h3>
      <p>Print this fun-filled Activity Book and solve the puzzles. <br /><a href="web/static/pdf/ActivityBook.pdf" target="_blank" style="text-decoration:underline;">Click Here for the ENERGY STAR<span class="registered">&reg;</span> Activity Book.</a> <br /><a href="web/static/pdf/HortonESActiv508.pdf" target="_blank" style="text-decoration:underline;">Click Here for the Horton Hears A Who! ENERGY STAR<span class="registered">&reg;</span> Activity Book.</a></p>
    </div>
    <div class="rightFloat"><img border="0" src="web/static/images/energyStar/energyStarCollage.jpg" /></div>
    <div class="clear"></div>
  </div>
</div>
    ...
    <ul>
        ...
        <li class="footContent"><img src="web/static/images/index/footer_logo.png" border="0" align="absmiddle" class="footLogo pngFix" /> 
          ...
          <span class="foot smallerText" style="padding-left:1px;">Copyright ©2004-Fri Jun 25 12:30:12 CDT 2010 Menard, Inc.</span>
        </li>
