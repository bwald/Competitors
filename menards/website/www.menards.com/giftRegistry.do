...
<div class="giftreg_main" style="height:auto;">
    	<div class="giftreg_main_image">
    		<div class="giftreg_main_text">
            	<h4>Real Gifts for Real Life</h4>
                <h2>You just got into your new place and there is a lot to be done. Let your friends know that moving is not the only thing that they can help you with!</h2>
               	<h3><a href="registry.do?startGR=create">Create Registry</a></h3>
               	<h3><a href="registry.do">Find Registry</a></h3>
            </div>
        </div>
