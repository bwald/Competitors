...
<title>Menards.com - Gift Cards</title>
...
<div id="page" class="mainContent secondaryPage">  
	...
	<img style="margin-left:40px;" src="web/static/images/giftCards/GIFTCARDMAIN.jpg" width="827" height="307" border="0" />
      <div style="padding-left:60px; padding-top:2px; width:800px;">
      <h6><p>Whether you are looking for gift for a loved one or just to say "Thank you!", with Menards Gift Cards you can make everyone on your list happy. <a href="giftCardsOrderBegin.do">Order yours now!</a></p>
<br><p>Last minute gift shopper? We will send your gift for you! <a href="javascript:policyWindow('giftCardsShippingInfo.do')">Click here</a> for Menards Gift Card delivery information and select the best shipping method to insure that your order arrives on time.</p>
<br><p>Menards gift cards can be redeemed at any of our many stores and they are sure to please, no guesswork, no exchange, no hassle, the perfect gift.
</p></h6> 
<img src="web/static/images/giftCards/giftcard_line.jpg" width="795" height="161" border="0" />
    </div>      

    <br />
   	<div id="otProtectPlan" class="leftFloat">
    <div class="hpHeaderBar">Gift Cards</div>
        <br><p>Give the perfect gift that everyone will appreciate; a Menards Gift Card.<br>Menards guarantees high quality name brand merchandise at the lowest price. To purchase, click the "Shop Now" button below. 
</p>
        <p class="rightFloat"><a href="giftCardsOrderBegin.do">Shop Now</a></p>
        </div>
   
       <div id="otReturnPol" class="rightFloat">
    <div class="hpHeaderBar">Corporate Gift Cards</div>
        <br><p>Menards Gift Cards - the gift that customers and employees will appreciate. Whether you want to honor career milestones, celebrate success, recognize achievement or motivate, a Menards Gift Card is an excellent way to do so. If you would like to place a gift card order, click the "Shop Now" link.</p>
       <br><p class="rightFloat"><a href="giftCardsOrderBegin.do?corporate=true">Shop Now</a></p>
        </div><br><br>
        <div class="clear"></div>
 ...
 <div class="clear"></div> 
    ...
    <ul>
        ...
        <li class="footContent"><img src="web/static/images/index/footer_logo.png" border="0" align="absmiddle" class="footLogo pngFix" /> 
          ...
          <span class="foot smallerText" style="padding-left:1px;">Copyright ©2004-Fri Jun 25 12:29:39 CDT 2010 Menard, Inc.</span>
        </li>
