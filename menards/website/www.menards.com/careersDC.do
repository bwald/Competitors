...
<title>Menards.com - Distribution Center Opportunities</title>
...
<div class="careers_margin"></div>
     ...
     <div class="title">
        <h2> <span class="subTitle"> Distribution Center Opportunities</span></h2>
    </div>
...
<table id="mainTable" border="1" bordercolor="#CCCCCC" width="900" cellpadding="0" cellspacing="0" bgcolor="#f9f9f9">
  <tr>
        <td>
          ...
          <div id="middleContent"><img src="web/static/images/careers/dcStore.jpg" width="265" height="234" border="0"/>
           <div id="middleContent_bottom">
           		<h2>Our Distribution Centers are located in Eau Claire, WI, Plano, IL, Shelby, IA and Holiday City, OH.  
               Together, these facilities service all of our stores throughout the Midwest, 
               with many new stores opening soon!</h2>
           </div>
          </div>
         ...
         <div id="leftContent">
         	<h2>Your training will cover the skills necessary to run a successful department, including:</h2>
               ...
               <br />
             <h4>Click the buttons for information about DC positions.</h4>
             <p>&nbsp;</p>
             <div style="text-align:center;">
             <a href="/careersHireBridgeHowTo.do"><img border="0" src="web/static/images/careers/btnHowApply.png" class="pngFix"></a></div>
                  
			 <div style="text-align:center;">
             <a href="/careersHireBridgeDC.do"><img border="0" src="web/static/images/careers/btnCurrentJob.png" class="pngFix"></a></div>
                  
			 <div style="text-align:center;">
             <a href="/careersHireBridgeSearch.do"><img border="0" src="web/static/images/careers/btnAdvancedSearch.png" class="pngFix"></a></div> 
...
<div class="clear"></div>			<div class="careers_general">
              <h5>Due to our continuing growth, we are always looking for hard working, fun, fast-paced individuals to join our winning team. Whether it is an entry-level warehouse position you are seeking, or a management position - the opportunities are endless!
              <br><br>
              To learn more about opportunities at the Menards Distribution Centers, contact us at: <br><br>
               MENARD, INC.<br />Employment Office<br />5126 Old Mill Plaza<br />Eau Claire, WI 54703
               <br><br>
               MENARD, INC.<br>Plano Visitors Center<br>2611 Eldamain Rd<br>Plano, IL 60545
               <br><br>
               MENARD, INC.<br>Shelby Visitors Center<br>9402 East St<br>Shelby, IA 51570
               <br><br>
               MENARD, INC.<br>Holiday City Visitors Center<br>14502 CR 15<br>Holiday City, OH 43554
			  </h5>
            </div>
  ...
  <br />
    ...
    <ul>
        ...
        <li class="footContent"><img src="web/static/images/index/footer_logo.png" border="0" align="absmiddle" class="footLogo pngFix" /> 
          ...
          <span class="foot smallerText" style="padding-left:1px;">Copyright ©2004-Fri Jun 25 12:30:17 CDT 2010 Menard, Inc.</span>
        </li>
