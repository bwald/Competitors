...
<div class="careers_margin"></div>
     <div class="title">
        <h2> <span class="subTitle"> HR Opportunities</span></h2>
    </div>
<table id="mainTable" border="1" bordercolor="#CCCCCC" width="900" height="500" cellpadding="0" cellspacing="0" bgcolor="#f9f9f9">
  <tr>
  <td style="padding:25px;">
<IFRAME src="http://www.hirebridge.com/jobseeker2/searchjobresults.asp?cid=5535&page=&jobcat=5" width=100% height=800px marginwidth=25px marginheight=0px frameBorder=0 name="frame1">
</IFRAME>
  </td>  
  </tr>
</table>
  ...
  <br />
    ...
    <ul>
        ...
        <li class="footContent"><img src="web/static/images/index/footer_logo.png" border="0" align="absmiddle" class="footLogo pngFix" /> 
          ...
          <span class="foot smallerText" style="padding-left:1px;">Copyright ©2004-Fri Jun 25 12:32:49 CDT 2010 Menard, Inc.</span>
        </li>
