...
<title>Menards.com - Featured Projects</title>
...
<script language="javascript" src="web/static/js/guestServices.js"></script>
    ...
    <div id="mainContent">
            ...
            <h1><span></span>Featured Projects</h1>
<br />
<div id="page" class="mainContent secondaryPage"> 


		<table width="95%" cellspacing="10" cellpadding="5">
		<tr><td colspan="3" class="mainPageInfo">Menards offers a wide variety of house design plans, garage building designs and post frame building designs to create your dream home. Listed below are the categories to
				choose from.</td></tr>
			<tr>
				<td valign="top"><a href="featuredProjects.do?dispatch=homesMain"><img align="absmiddle" src="web/static/images/featuredProjects/mainHouse.jpg" border="0"></a></td>
				<td><a href="featuredProjects.do?dispatch=garagesMain"><img align="absmiddle" src="web/static/images/featuredProjects/mainGarage.jpg" border="0"></a></td>
				<td><a href="featuredProjects.do?dispatch=postFramesMain"><img align="absmiddle" src="web/static/images/featuredProjects/mainPostFrame.jpg" border="0"></a></td>
	</tr>
			<tr>
				<td  valign="top" class="sSubtitle">Browse through over 100 pre-priced homes and floor plans.  Many styles and types to choose from.</td>
				<td valign="top" class="sSubtitle">Menards features a variety of garage designs and options, sample some of our plans and prices.</td>
				<td  valign="top" class="sSubtitle">Check out our wide selection of sizes and options.</td>
			</tr>				
			<tr>
			<Td class="sSubtitle"><a href="featuredProjects.do?dispatch=homesMain"><img align="absmiddle" src="web/static/images/featuredProjects/grArrow.gif" border="0"><b>View All Homes</b></a></Td>
			<Td class="sSubtitle"><a href="featuredProjects.do?dispatch=garagesMain"><img align="absmiddle" src="web/static/images/featuredProjects/grArrow.gif" border="0"><b>View All Garages</b></a></Td>
			<td class="sSubtitle"><a href="featuredProjects.do?dispatch=postFramesMain"><img align="absmiddle" src="web/static/images/featuredProjects/grArrow.gif" border="0"><b>View All Post Frames</b></a></td>
			</tr>
    ...
    <ul>
        ...
        <li class="footContent"><img src="web/static/images/index/footer_logo.png" border="0" align="absmiddle" class="footLogo pngFix" /> 
          ...
          <span class="foot smallerText" style="padding-left:1px;">Copyright ©2004-Fri Jun 25 12:36:38 CDT 2010 Menard, Inc.</span>
        </li>
