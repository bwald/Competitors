...
<title>Menards.com - Online Job Applications</title>
...
<div id="mainContent">
<h1><span></span>Careers</h1>
<br />
<div id="page" class="mainContent secondaryPage">
<div class="careers_margin"></div>
	
     <div class="title">
        <h2><span class="layout2Heading">How to Apply</span></h2>
    </div>

<table id="mainTable" border="1" bordercolor="#CCCCCC" width="900" cellpadding="0" cellspacing="0" bgcolor="#f9f9f9">
  <tr>
        <td>
        
          <div id="rightContent"> 
          	<div class="rightNav"> 
            <a href="careers.do" class="mainCat"> 
              <h2>Careers</h2>
            </a><a href="careersBenefits.do" class="catLink">Benefits</a> 
             
            <a href="careersTrainee.do" class="catLink">Manager Trainee</a> 
            <a href="careersInternship.do" class="catLink">Internship Program</a> 
            <br>
            <br><span class="scheduleTitle2"> 
              <h2>Job Opportunities</h2> &nbsp; 
              </span> 
            <a href="careersStore.do" class="catLink">Retail Store</a> 
            <a href="careersDC.do" class="catLink">Distribution Center</a> 
            <a href="careersGO.do" class="catLink">General Office</a> 
            <a href="http://www.midwestmanufacturing.com/Careers.jsp" class="catLink" target="_blank">Manufacturing Division</a> 
            </div> 
          </div>
          
          <div id="middleContent"><img src="web/static/images/careers/interView.jpg" width="265" height="234" border="0" />
           <div id="middleContent_bottom">
           		<h2>&nbsp;</h2>
           </div>
          </div>
         
         <div id="leftContent">
         	<h2>To apply for a Menards General Office position, we prefer that all applications and resume submissions be made through our online career center. Our Career Center has been designed to make the application and resume submission process fast and easy. When you apply through our online system, you will receive an email confirming that your application is in the system and that we will review it.<br /><br />Our online application is secure, using the highest degree of encryption, so your data is safe.</h2>
            
         	<br />
             <h4><span class="grCarSubTitle">Click the buttons for information about General Office positions.</span></h4>
             <p>&nbsp;</p>
             <div style="text-align:center;">
            <a href="/careersHireBridge.do"><img border="0" src="web/static/images/careers/btnCurrentJob.png" class="pngFix"></a></div>
                  
			 <div style="text-align:center;">
            <a href="/careersHireBridgeSearch.do"><img border="0" src="web/static/images/careers/btnAdvancedSearch.png" class="pngFix"></a>
		    </div>
...
<div class="clear"></div>			
<div class="careers_general">
              <h2>Applying for a general office position</h2><h5>We prefer that all applications and resume submissions be made through our online career center.</h5></div>

			<div class="careers_general">
              <h2>Applying for a retail store position</h2><h5>To apply for an available position at a local new or existing retail store, please stop in to one of our existing store locations and apply in person.</h5></div>
              
			<div class="careers_general">
              <h2>Applying for a specific position</h2>
    <h5>If you are applying for a specific job, please apply from that specific job listing by clicking on the "Submit Your Profile " Online button.</h5></div>
              
			<div class="careers_general">
              <h2>Applying for general consideration</h2>
    <h5>If you can’t find a particular position that interests you at this time but would like to send us your resume, we encourage you to apply using our General Application. Should a position come up that we feel would match your abilities and experience, we will contact you.</h5></div>
    
	<div class="careers_general">
      <h2>Apply with a resume</h2>
    <h5>If you already have a text version of your resume, you can apply using the cut and paste method and paste your resume and cover letter into our application form.</h5>
	</div>
 
	<div class="careers_general">
      <h2>Apply using our resume builder</h2>
    <h5>If you don’t have a text resume, you can use our Resume Builder to create a resume.</h5>
	</div>
    
	<div class="careers_general">
      <h2>Creating an email account</h2>
    <h5>In order to apply using our online system, you must have access to an email account. If you don’t currently have an email account, we suggest that you go to <a href="http://www.hotmail.com/" target="_blank">www.hotmail.com</a> or to <a href="http://www.yahoo.com/" target="_blank">www.yahoo.com</a> and create one. </h5>
	</div>
    
    <div class="clear"></div>
  <br />
  	<div class="careers_box_secondary">
    	<div class="benifits">
        	<h2>Benefits</h2>
            <h3>At Menards, you will not only experience a fun-filled work environment, but will be rewarded with outstanding pay and benefits! <a href="careersBenefits.do">Learn More ></a></h3>
        </div>
    </div>
    <div class="careers_margin"></div>
  </div>
    ...
    <ul>
        ...
        <li class="footContent"><img src="web/static/images/index/footer_logo.png" border="0" align="absmiddle" class="footLogo pngFix" /> 
          ...
          <span class="foot smallerText" style="padding-left:1px;">Copyright ©2004-Fri Jun 25 12:32:50 CDT 2010 Menard, Inc.</span>
        </li>
