...
<title>Menards.com - Menards Benefits</title>
...
<table id="mainTable" border="1" bordercolor="#CCCCCC" width="900" cellpadding="0" cellspacing="0" bgcolor="#f9f9f9">
  <tr>
        <td>
          ...
          <div id="middleContent"><img src="web/static/images/careers/storeIPS.jpg" width="265" height="234" border="0" />
           <div id="middleContent_bottom">
           		<h2>At Menards, you will not only experience a fun-filled work environment, 
            but will be rewarded with outstanding pay and benefits!</h2>
           </div>
          </div>
         
         <div id="leftContent">
         	<h2>Our benefits vary by position, but include the following:</h2>
            	<ul>
                
                  <li>401(k) Retirement Plan</li>
                  <li>Health, Life, and Disability Insurance</li>
                  <li>Dental Insurance </li>
                  <li>Paid Vacations</li>
                  <li>Paid Holidays</li>
                  <li>Instant Profit Sharing</li>
                  <li>Weekend Bonus Pay</li>
                  <li>Holiday Bonuses</li>
                  <li>Management Bonuses</li>
                  <li>Team Member Discount</li>
            </ul>
               <br />
  ...
  <br />
    ...
    <ul>
        ...
        <li class="footContent"><img src="web/static/images/index/footer_logo.png" border="0" align="absmiddle" class="footLogo pngFix" /> 
          ...
          <span class="foot smallerText" style="padding-left:1px;">Copyright ©2004-Fri Jun 25 12:30:18 CDT 2010 Menard, Inc.</span>
        </li>
