...
<title>Menards.com - General Office Opportunities</title>
...
<div class="careers_margin"></div>
     ...
     <div class="title">
        <h2><span class="subTitle">General Office Opportunities</span></h2>
    </div>
...
<table id="mainTable" border="1" bordercolor="#CCCCCC" width="900" cellpadding="0" cellspacing="0" bgcolor="#f9f9f9">
  <tr>
        <td>
          ...
          <div id="middleContent"><img src="web/static/images/careers/goPeople.jpg" width="265" height="234" border="0" />
           <div id="middleContent_bottom">
           		<h2>Picture yourself at the hub of activity that surrounds Menards - the General Office. 
            Located in scenic Eau Claire, Wisconsin, the Menard, Inc.<br /><br />Located in scenic Eau Claire, Wisconsin, the Menard, Inc. General Office provides many opportunities for Team Members to advance their careers within the company. Take advantage of the great pay and benefits Menard, Inc. has to offer. </h2>
           </div>
          </div>
         
         <div id="leftContent">
         	<h2>As positions become available, we frequently hire and promote our Team Members into several 
            areas including:</h2>
            	<ul>
            	  <li>Accounting</li>
                  <li>Computer Programming and Support</li>
                  ...
                  <li>Merchandising</li>
                  <li>Operations</li>
                  <li>Properties &amp; Facilities Management</li>
                  <li>Real Estate</li>
                  <li>Security</li>
                  <li>Team Member Training and Development</li>
            </ul>
               <br />
             <h4>Click the buttons for information about General Office positions.</h4>
             <p>&nbsp;</p>
