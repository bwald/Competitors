...
<div class="careers_margin"></div>
     <div class="title">
        <h2> <span class="subTitle">Retail Store Opportunities</span></h2>
    </div>
<table id="mainTable" border="1" bordercolor="#CCCCCC" width="900" height="500" cellpadding="0" cellspacing="0" bgcolor="#f9f9f9">
  <tr>
  <td style="padding:25px;">

<IFRAME src="http://www.hirebridge.com/jobseeker2/searchjobresults.asp?cid=5535&page=&jobcat=10&sort=1" width=100% height=800px marginwidth=25px marginheight=0px frameBorder=0 name="frame1">
</IFRAME></td>
</tr></table>
