...
<title>Menards.com - Rebate Coupons</title>
...
<h1><span></span>Rebates</h1>
<br />
<div id="page" class=" mainContent secondaryPage">
      
<div class="rebate_main_background">
	<div class="rebate_main_info">
    	<h2>Print Rebate Coupons</h2>
    	<h5>If you did not pick up a rebate coupon at our store, simply enter the four digit rebate number displayed on your rebate receipt and print out the rebate coupon that appears.</h5>
    </div>
    
    <div class="rebate_form">
      <h5 class="accentText">Enter Rebate Number Here:</h5>
      	<div>
  			<form name="rebateLocatorForm" method="POST" action="/rebateLocator.do" onsubmit="return validateForm(this);">
  			<input type="text" name="rebateNumber" maxlength="4" size="10" value="" > 
  			<input type="image" class="pngFix" name="" align="absmiddle" src="web/static/images/index/btn_FindRebate.png" border="0">
			</form>
       </div>
    </div>
    
    <div class="rebate_form_info">
   	  <h5>Fill in your information on the rebate coupon and mail the rebate along with your rebate receipt to the address listed on the rebate coupon. Please refer to the rebate coupon for additional instructions.</h5>
    </div>
    ...
    <ul>
        ...
        <li class="footContent"><img src="web/static/images/index/footer_logo.png" border="0" align="absmiddle" class="footLogo pngFix" /> 
          ...
          <span class="foot smallerText" style="padding-left:1px;">Copyright ©2004-Fri Jun 25 12:29:36 CDT 2010 Menard, Inc.</span>
        </li>
