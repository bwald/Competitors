...
<title>Menards.com - Management Internship Program</title>
...
<div class="careers_margin"></div>
     ...
     <div class="title">
        <h2>Management Internship Program</h2>
    </div>
...
<table id="mainTable" border="1" bordercolor="#CCCCCC" width="900" cellpadding="0" cellspacing="0" bgcolor="#f9f9f9">
  <tr>
        <td>
          ...
          <div id="middleContent"><img src="web/static/images/careers/learnSelling.jpg" width="265" height="234" border="0" />
           <div id="middleContent_bottom">
           		<h2>Are you a business student looking for a fun and exciting internship?</h2>
           </div>
          </div>
         
         <div id="leftContent">
         	<h2>This once-in-lifetime opportunity will give you the experience necessary for every 
            professional entering the workforce. Training is extensive and covers a wide array of topics, 
            including:</h2>
            	<ul>
                
                  <li>Selling and Merchandising</li>
                  <li>Product Knowledge</li>
                  <li>Providing Great Guest Service</li>
                  <li>Prioritization</li>
                  <li>Building Leadership Skills </li>
            </ul>
               <br />
             <h4>TO APPLY OR LEARN MORE:</h4>
             <h5>Stop by any existing Menards location and talk to the Human Resource Coordinator today!</h5>
...
<div class="clear"></div>			<div class="careers_general">
              <h5>Menards offers a 12-week, paid Management Internship Program that includes on-the-job training and learning experiences that will teach you about the daily responsibilities and activities of our managers.<br><br>
              As a Management Intern, you will spend 12 action-filled weeks working at any one of our numerous store locations. You will be given the unique opportunity to work directly with the Department Management Team and General Managers to develop an understanding of the skills needed to run a successful department. In addition, rotating throughout the various departments of the store will allow you to gain an overall understanding of how the Menards business works.</h5><br>
            </div>
  ...
  <br />
    ...
    <ul>
        ...
        <li class="footContent"><img src="web/static/images/index/footer_logo.png" border="0" align="absmiddle" class="footLogo pngFix" /> 
          ...
          <span class="foot smallerText" style="padding-left:1px;">Copyright ©2004-Fri Jun 25 12:32:48 CDT 2010 Menard, Inc.</span>
        </li>
