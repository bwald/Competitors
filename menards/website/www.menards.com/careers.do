...
<title>Menards.com - Careers</title>
...
<div class="main_careers_image">
	<div class="main_careers_image_main pngFix"></div>
</div>

<div id="page" class="secondaryPage">
<div class="careers_margin"></div>
	<div class="careers_box">
		<h6>Menards home improvement stores are conveniently located throughout the Midwest in a 12-state region.  Menards has something for everyone from the beginning do-it-yourselfer to the experienced contractor.  A family-owned and operated business, Menards is truly dedicated to service and quality and the place to "Save Big Money" on all your home improvement needs.</h6>
        <br></br>
        <h6>Menards offers exceptional advancement opportunities, a fun work place, as well as great pay and benefits!  If you are a hard-working, guest-oriented person, we have opportunities for you!</h6>
  </div>
    <div class="title">
        <h2>Featured Opportunities</h2>
    </div>
    <div class="wrap_catigories">
    <div class="catigories">
    	<h2><a href="/careersStore.do" class="careersLink">Retail</a></h2>
        	<ul>
            	<li>Full-Time Sales</li>
                <li>Part-Time Sales / Stocking</li>
            	<li>Morning Stocking</li>
            	<li>Cashier</li>
            	<li>Guest Service</li>
            	<li>Shipping/Receiving</li>
            	<li>Commercial Contractor Sales</li>
            </ul>
            <br>
            <h2><a href="/careersStore.do" class="careersLink">Learn More >></a></h2>
    </div>
    
    <div class="catigories">
    	<h2><a href="/careersDC.do" class="careersLink">Distribution Center</a></h2>
        	<ul>
            	<li>Building Management</li>
                <li> Planning &amp; Inventory </li>
            	...
            	<li> Manager Trainee </li>
            </ul>
            <br>
            <h2><a href="/careersDC.do" class="careersLink">Learn More >></a></h2>
    </div>
    
    <div class="catigories">
    	<h2><a href="/careersGO.do" class="careersLink">General Office</a></h2>
        	<ul>
            	<li> Accounting </li>
            ...
            <br>
            <h2><a href="/careersGO.do" class="careersLink">Learn More >></a></h2>
    </div>
    
    <div class="catigories">
    	<h2><a class="careersLink" href="http://www.midwestmanufacturing.com/Careers.jsp" target="_blank">Manufacturing</a></h2>
        	<ul>
            	<li> Production Team Manager </li>
                <li> Maintenance Mechanic</li>
            	<li> CAD Operator</li>
            	<li> Internet Systems</li>
            	<li> Controller Trainee</li>
            	<li> Engineering Programmer</li>
            	<li> Manager Trainee</li>
            </ul>
            <br>
            <h2><a class="careersLink" href="http://www.midwestmanufacturing.com/Careers.jsp" target="_blank">Learn More >></a></h2>
    </div>
