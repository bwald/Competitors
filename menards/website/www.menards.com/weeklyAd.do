...
<title>Menards.com - Weekly Ad</title>
...
<h1><span></span>Weekly Ad</h1>
<br>
<div id="page" class="mainContent secondaryPage">
<table id="mainTable" border="0" width="940" height="500" cellpadding="0" cellspacing="0">
  <tr>
    <td>
    

  <IFRAME src="http://menards.inserts2online.com/storeReview.jsp?drpStoreID=1" frameborder="0" width="940" height="800" name="whatsNew" id="whatsNew" style="overflow:auto;" marginwidth="25px" marginheight="0px"></IFRAME>
   </td>
  </tr>
</table>
</div>
