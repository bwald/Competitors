...
<title>Menards.com - Manager Trainee Program</title>
...
<table id="mainTable" border="1" bordercolor="#CCCCCC" width="900" cellpadding="0" cellspacing="0" bgcolor="#f9f9f9">
  <tr>
        <td>
          ...
          <div id="middleContent"><img src="web/static/images/careers/storeManager.jpg" width="265" height="234" border="0" />
           <div id="middleContent_bottom">
           		<h2>Menards has opportunities for Business graduates in our Manager Trainee Program.  
            Our 3-month Manager Trainee Program provides the first stepping-stone to a promising 
            career with Menards.</h2>
           </div>
          </div>
         
         <div id="leftContent">
         	<h2>Your training will cover the skills necessary to run a successful department, including:</h2>
            	<ul>
                
                  <li>Department Maintenance</li>
                  ...
                  <li>Assistant Department Manager Training</li>
               </ul>
               <br />
             <h4>Click the button to apply for a Manager Trainee position.</h4>
             <p>&nbsp;</p>
             <div style="text-align:center;">
           <a href="javascript:applyMTWindow('https://www.hirebridge.com/application/appchoice.asp?jid=18724')"><img border="0" src="web/static/images/careers/btnApplyJob.png" class="pngFix"></a>
             </div>
...
<div class="clear"></div>
			<div class="careers_general">
              <h5>You will experience first-hand how our Team atmosphere has been a direct influence on the success of our company. In addition, rotating through different departments will expose you to the variety of products that we sell and the array of management styles that are in our stores. Working alongside already accomplished managers will give you insight on how they motivate their Team, organize their departments, and train their Team Members for success.<br><br>
              Once you have graduated from our Manager Trainee Program, you will have the opportunity to advance your career within the company by being promoted to an Assistant Department Manager at one of our Menards locations. A willingness to relocate and Menards' "promotion from within" policy will allow Manager Trainees to advance their careers with opportunities at the stores, distribution centers, or at our General Office.<br><br>
               Steps to Success Menards has a "Steps to Success" program for our Team Members' progression into Management. At each level, our Team Members are learning and developing their skills to be successful. By using a "step by step" process to promote up the ladder, we are better preparing our Managers for the responsibilities and challenges that come with higher-level management.</h5>
  ...
  <br />
    ...
    <ul>
        ...
        <li class="footContent"><img src="web/static/images/index/footer_logo.png" border="0" align="absmiddle" class="footLogo pngFix" /> 
          ...
          <span class="foot smallerText" style="padding-left:1px;">Copyright ©2004-Fri Jun 25 12:32:47 CDT 2010 Menard, Inc.</span>
        </li>
