...
<title>Menards.com - Retail Store Opportunities</title>
...
<div class="careers_margin"></div>
     ...
     <div class="title">
        <h2>Retail Store Opportunities</h2>
    </div>
...
<table id="mainTable" border="1" bordercolor="#CCCCCC" width="900" cellpadding="0" cellspacing="0" bgcolor="#f9f9f9">
  <tr>
        <td>
          ...
          <div id="middleContent"><img src="web/static/images/careers/storePeople.jpg" width="265" height="234" border="0" />
           <div id="middleContent_bottom">
           		<h2>Menards Team Members are rewarded based on performance. We promote from within and take great pride in preparing our Team Members to move into more responsible positions within our company.</h2>
           </div>
          </div>
         
         <div id="leftContent">
         	<h2>Our stores offer part-time and full-time job opportunities in several departments including:</h2>
            	<ul>
...
<div class="clear"></div>
			<div class="careers_general">
              <h2>Interested in the Human Resource Coordinator or a Manager Trainee postion at a store near you?</h2>
              <h3><a href="/careersHireBridgeHR.do">Click here for current openings for all locations.</a></h3>

            </div>
            
            <div class="careers_general">
              <h2>Want to be a future Store Manager?</h2>
              <h3><a href="/careersTrainee.do" class="blue">Check out the Manager Trainee page for more information.</a></h3>
            </div>
            
            <div class="careers_general">
              <h2>Interested in working at a store near you?</h2>
              <h2>Stop by any of our existing store locations and talk with the Human Resource Coordinator!</h2>
            </div>

            <div class="careers_general">
              <h4><a href="/careersHireBridgeStore.do" class="blue">Click here to apply for a specific store location.</a></h4>
            </div>
